...
(function () {
  ...
  var DECK_SCENES = [
    ...
    },
    {
      id: 'audio',
      tab: 'Music Studio',
      url: 'studio.music.fun-music',
      badge: 'Fun-Music Synthesis',
      engine: 'DashScope Fun-Music v1',
      latency: '< 12s Full Track Generation',
      prompt: 'Upbeat synthwave with heavy bass, cinematic drums, travel vlog energy',
